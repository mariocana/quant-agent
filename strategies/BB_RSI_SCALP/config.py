...
STRATEGY = {
    ...
    "symbol_filters": {
        "categories": ["forex", "indices", "commodities"],  # Which categories to trade
    ...
    "bb_rsi": {
        ...
        # ── WHITELIST: solo simboli testati e profittevoli ──
        # Backtest 6 mesi: tutti WR > 59%, PF > 1.3, DD < 4%
        "symbols": [
            "GBPUSD",   # WR 59.4% | PF 1.39 | +$10,854 | 🏆 challenge passed
